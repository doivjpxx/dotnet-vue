<template>
  <div>
    ...
    <div class="invoice-step" v-if="invoiceStep === 3">
      ...
      <SolarButton @button:click="submitInvoice">Submit Invoice</SolarButton>
      <hr />
    ...
    <div class="invoice-steps-actions">
      <SolarButton @button:click="prev" :disabled="!canGoPrev"
        >Previous</SolarButton
      >
      <SolarButton @button:click="next" :disabled="!canGoNext"
        >Next</SolarButton
      >
      <SolarButton @button:click="startOver">Start Over</SolarButton>
    </div>
  </div>
</template>
...
export default class CreateInvoice extends Vue {
  ...
  async submitInvoice(): Promise<any> {
    this.invoice = {
